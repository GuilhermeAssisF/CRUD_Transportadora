                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item">
                        <%-- Lógica para o item "Produtos" --%>
                            <c:set var="isProdutosActive"
                                value="${pageContext.request.servletPath eq '/produtos' || pageContext.request.servletPath eq '/produtos/'}" />
                            <c:choose>
                        ...
                        <ul class="nav nav-pills flex-column mb-auto">
                            ...
                            <li class="nav-item">
                                <%-- Lógica para o item "Produtos" no mobile --%>
                                    <c:set var="isProdutosActiveMobile"
                                        value="${pageContext.request.servletPath eq '/produtos' || pageContext.request.servletPath eq '/produtos/'}" />
                                    <c:choose>
